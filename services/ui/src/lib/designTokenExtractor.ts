...
function buildCssVariables(
  ...
  const headingFontFamily = typography.fonts[0]
    ? `'${FONT_MAP[typography.fonts[0]]?.family ?? typography.fonts[0]}', -apple-system, BlinkMacSystemFont, sans-serif`
    : '-apple-system, BlinkMacSystemFont, sans-serif'
  const bodyFontFamily = typography.fonts[1]
    ? `'${FONT_MAP[typography.fonts[1]]?.family ?? typography.fonts[1]}', -apple-system, BlinkMacSystemFont, sans-serif`
    : headingFontFamily
