...
export function PricingSection({ content, tokens, index, sections = [] }: Props) {
  ...
  return (
    ...
    >
      ...
      <div style={{ position: 'absolute', left: '-3%', top: '5%', fontFamily: `'${tokens.heroFont}', serif`, fontSize: 'clamp(8rem, 18vw, 16rem)', fontWeight: tokens.heroWeight, color: tokens.text, opacity: 0.02, lineHeight: 1, pointerEvents: 'none', zIndex: 1 }}>
