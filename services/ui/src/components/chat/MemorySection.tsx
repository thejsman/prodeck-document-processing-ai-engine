...
const CATEGORIES: ClientKnowledgeEntry['category'][] = ['preference', 'constraint', 'relationship', 'context'];
...
const CATEGORY_DISPLAY: Record<ClientKnowledgeEntry['category'], string> = {
    ...
    <div className="brief-field-card">
      <div className="brief-field-edit-body">
        <textarea
          ...
          placeholder={`Add a ${CATEGORY_DISPLAY[category].toLowerCase()}…`}
          rows={2}
        />
        <div className="brief-field-edit-actions">
