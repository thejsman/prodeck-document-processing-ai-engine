...
[data-section-id] svg{max-height:120px!important;max-width:120px!important;}
              ...
              : `$1<style id="__pdf-slide-constraints__">[data-section-id]{aspect-ratio:16/9!important;overflow:hidden!important;position:relative!important;min-height:unset!important;height:auto!important;max-height:none!important;width:100%!important;box-sizing:border-box!important;}[data-section-id] svg{max-height:140px;max-width:140px;}[data-section-id] img{max-height:42%;object-fit:cover;}</style>`,
          )
        : html;
