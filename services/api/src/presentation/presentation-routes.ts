...
[data-ls-callout]{flex-shrink:0!important;margin-top:auto!important;}
              ...
              : `$1<meta charset="UTF-8"><style id="__pdf-slide-constraints__">html{margin:0!important;padding:0!important;overflow-x:hidden!important;}body{margin:0!important;padding:0!important;overflow-x:hidden!important;display:block!important;}[data-section-id]{position:relative!important;overflow:hidden!important;box-sizing:border-box!important;width:100%!important;flex-shrink:0!important;min-height:0!important;}[data-section-id]>.__slide-content{position:absolute!important;top:0!important;left:0!important;width:1280px!important;height:720px!important;transform-origin:top left!important;display:flex!important;flex-direction:column!important;overflow:hidden!important;box-sizing:border-box!important;}[data-ls-content]{flex:1!important;min-height:0!important;overflow:hidden!important;}[data-ls-callout]{flex-shrink:0!important;margin-top:auto!important;overflow:visible!important;max-height:none!important;}[data-section-id]>.__slide-content>div:last-child:not([data-ls-content]):not([style*="position:absolute"]):not([style*="position: absolute"]){flex-shrink:0!important;margin-top:auto!important;overflow:visible!important;}[data-section-id] img:not([id^="__site-logo"]){max-height:none!important;}[data-section-id] svg{max-height:140px!important;max-width:140px!important;}[data-section-id] ul,[data-section-id] ol,[data-section-id] table{max-width:none!important;width:100%!important;}@supports(aspect-ratio:1){[data-section-id]:not([style*="height"]){aspect-ratio:16/9;}}@media print{@page{size:1280px 720px;margin:0;}html,body{width:1280px!important;}[data-section-id]{width:1280px!important;height:720px!important;page-break-after:always!important;break-after:page!important;overflow:hidden!important;margin:0!important;}[data-section-id]>.__slide-content{transform:none!important;position:relative!important;}[data-pdf-hide]{display:none!important;}}</style><script id="__slide-scaler__">(function(){var W=1280,H=720;var isPdf=/HeadlessChrome/i.test(navigator.userAgent);function autoTag(){if(!document.querySelector('[data-section-id]')){document.querySelectorAll('section:not([data-pdf-hide])').forEach(function(el,i){el.setAttribute('data-section-id',el.id||('slide-'+(i+1)));});}}function wrapSlide(s){if(s.querySelector(':scope>.__slide-content'))return;var st=s.getAttribute('style')||'';var noPad=/\bpadding\s*:\s*0(px)?\b/.test(st);var inner=document.createElement('div');inner.className='__slide-content';if(!noPad){var pm=st.match(/\bpadding\s*:\s*([^;]+)/i);inner.style.padding=pm?pm[1].trim():'48px 72px';}var ns=Array.prototype.slice.call(s.childNodes);for(var i=0;i<ns.length;i++)inner.appendChild(ns[i]);s.appendChild(inner);s.style.setProperty('padding','0','important');}function scaleSlide(slide){wrapSlide(slide);var inner=slide.querySelector(':scope>.__slide-content');if(!inner)return;if(isPdf){slide.style.setProperty('width',W+'px','important');slide.style.setProperty('height',H+'px','important');inner.style.position='relative';inner.style.transform='none';return;}var w=slide.getBoundingClientRect().width||slide.offsetWidth;if(w<1)return;var s=+(w/W).toFixed(6);slide.style.setProperty('height',Math.round(s*H)+'px','important');inner.style.transform=Math.abs(s-1)<0.001?'none':'scale('+s+')';}function init(){autoTag();var slides=Array.prototype.slice.call(document.querySelectorAll('[data-section-id]'));slides.forEach(scaleSlide);if(window.ResizeObserver){var ro=new window.ResizeObserver(function(entries){entries.forEach(function(e){scaleSlide(e.target);});});slides.forEach(function(el){ro.observe(el);});}else{window.addEventListener('resize',function(){document.querySelectorAll('[data-section-id]').forEach(scaleSlide);});}}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',init);}else{init();}window.addEventListener('load',function(){document.querySelectorAll('[data-section-id]').forEach(scaleSlide);});}());<\/script>`,
          )
        : html;
